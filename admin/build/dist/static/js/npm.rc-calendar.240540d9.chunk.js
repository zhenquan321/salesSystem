      ...
      var w = (function(e) {
          function t(a) {
            ...
            return (
              ...
              (n.state = { value: a.value || a.defaultValue }),
              (n.nextDecade = D.bind(n, 10)),
              (n.previousDecade = D.bind(n, -10)),
              n
            );
          }
          return (
        ...
        return (
          ...
          (t.prototype.render = function() {
            var e = this.props,
              ...
              R = a + '-last-day-of-month',
              Y = o.clone();
            Y.date(1);
            var A = (Y.day() + 7 - o.localeData().firstDayOfWeek()) % 7,
              H = Y.clone();
            H.add(0 - A, 'days');
            var K = 0;
            for (c = 0; c < d; c++)
              for (p = 0; p < h; p++) (f = H), K && (f = f.clone()).add(K, 'days'), m.push(f), K++;
            var B,
              W = [];
            for (K = 0, c = 0; c < d; c++) {
              var L,
        ...
        return (
          ...
          (t.prototype.render = function() {
            var e,
              ...
              D = void 0,
              T = void 0;
            l && (Array.isArray(l) ? ((D = l[0]), (T = l[1])) : (D = T = l));
            var x = !0 === c || (!1 !== c && !!i),
              j = y()(
                (((t = {})[r + '-footer'] = !0),
                (t[r + '-range-bottom'] = !0),
              ...
              R = F.month(),
              Y = F.year(),
              A = (I.year() === Y && I.month() === R) || (M.year() === Y && M.month() === R),
              H = I.clone().add(1, 'months'),
              K = H.year() === M.year() && H.month() === M.month(),
              B = a.renderFooter();
            return h.a.createElement(
              'div',
              {
        ...
        (this.onDatePanelEnter = function() {
          ...
          (this.onSelect = function(t) {
            ...
            if ('both' === a)
              l
                ? e.compare(l, t) < 0
                  ? (Object(P.h)(r[1], t), (s = [l, t]))
                  : (Object(P.h)(r[0], t), Object(P.h)(r[1], l), (s = [t, l]))
                : (Object(P.h)(r[0], t), (s = [t]));
            else if ('start' === a) {
              Object(P.h)(r[0], t);
              var i = o[1];
          ...
          (this.getStartValue = function() {
            var t = e.state,
              ...
              s = o[0];
            return (
              a[0] && e.props.timePicker && ((s = s.clone()), Object(P.h)(a[0], s)),
              n && a[0] && (s = a[0]),
              'end' === l &&
                'date' === r[0] &&
                'date' === r[1] &&
          ...
          (this.getEndValue = function() {
            ...
            return (
              n[1] && e.props.timePicker && Object(P.h)(n[1], s),
          ...
          (this.fireSelectValueChange = function(t, a, n) {
            ...
            if (o && o.props.defaultValue) {
              ...
              !r[0] && t[0] && Object(P.h)(l[0], t[0]), !r[1] && t[1] && Object(P.h)(l[1], t[1]);
            }
            if (
