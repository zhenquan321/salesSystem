(window.webpackJsonp = window.webpackJsonp || []).push([
  [1],
  {
    1127: function(a, n, t) {
      a.exports = {
        'margin-mini': 'margin-mini--1wkR6',
        'padding-mini': 'padding-mini--3TTPA',
        'margin-top-mini': 'margin-top-mini--2PxDi',
        'padding-top-mini': 'padding-top-mini--2uf2j',
        'margin-right-mini': 'margin-right-mini--1nwrq',
        'padding-right-mini': 'padding-right-mini--diOBu',
        'margin-bottom-mini': 'margin-bottom-mini--k0PFe',
        'padding-bottom-mini': 'padding-bottom-mini--PKm0d',
        'margin-left-mini': 'margin-left-mini--3C48Y',
        'padding-left-mini': 'padding-left-mini--3y83Q',
        'margin-small': 'margin-small--3crqD',
        'padding-small': 'padding-small--2ZrLp',
        'margin-top-small': 'margin-top-small--2IdqV',
        'padding-top-small': 'padding-top-small--4VURe',
        'margin-right-small': 'margin-right-small--2eVsM',
        'padding-right-small': 'padding-right-small--wo2Bw',
        'margin-bottom-small': 'margin-bottom-small--1kzvk',
        'padding-bottom-small': 'padding-bottom-small--1WLmp',
        'margin-left-small': 'margin-left-small--2fGNa',
        'padding-left-small': 'padding-left-small--16Ojr',
        'margin-normal': 'margin-normal--2fhC-',
        'padding-normal': 'padding-normal--3jM--',
        'margin-top-normal': 'margin-top-normal--2ciAv',
        'padding-top-normal': 'padding-top-normal--1Pk7D',
        'margin-right-normal': 'margin-right-normal--2tjmv',
        'padding-right-normal': 'padding-right-normal--2XR-2',
        'margin-bottom-normal': 'margin-bottom-normal--1Olhm',
        'padding-bottom-normal': 'padding-bottom-normal--1tSU7',
        'margin-left-normal': 'margin-left-normal--293l_',
        'padding-left-normal': 'padding-left-normal--1L-Kt',
        'margin-large': 'margin-large--2rjaE',
        'padding-large': 'padding-large--3wnfx',
        'margin-top-large': 'margin-top-large--Uqv3W',
        'padding-top-large': 'padding-top-large--3P3As',
        'margin-right-large': 'margin-right-large--22ZqX',
        'padding-right-large': 'padding-right-large--19G5X',
        'margin-bottom-large': 'margin-bottom-large--UC5oZ',
        'padding-bottom-large': 'padding-bottom-large--1EHvP',
        'margin-left-large': 'margin-left-large--awJ4b',
        'padding-left-large': 'padding-left-large--G5UIR',
        header: 'header--3hAz6',
        collapsed: 'collapsed--136sj',
        isMobile: 'isMobile--3LlBP',
        foldIcon: 'foldIcon--3PWm1',
        rightPart: 'rightPart--1FaWP',
        userInfo: 'userInfo--t_7Xx',
        userIcon: 'userIcon--pJXur',
        userDropdown: 'userDropdown--2pSPU',
        clock: 'clock--caYM-',
        text: 'text--11uxD',
        clockIcon: 'clockIcon--2POfb',
        showTime: 'showTime--2rZ1W',
        menuItem: 'menuItem---LJh5'
      };
    },
    1129: function(a, n, t) {
      a.exports = {
        ...
        pageWrapper: 'pageWrapper--1d-gW',
        pageBody: 'pageBody--E6dhw',
    ...
    1172: function(a, n, t) {
      a.exports = {
        'margin-mini': 'margin-mini--1Bo8N',
        'padding-mini': 'padding-mini--1AA84',
        'margin-top-mini': 'margin-top-mini--228Eq',
        'padding-top-mini': 'padding-top-mini--UaR-5',
        'margin-right-mini': 'margin-right-mini--naRm9',
        'padding-right-mini': 'padding-right-mini--3Mm2_',
        'margin-bottom-mini': 'margin-bottom-mini--1kmE2',
        'padding-bottom-mini': 'padding-bottom-mini--1zSz-',
        'margin-left-mini': 'margin-left-mini--2796K',
        'padding-left-mini': 'padding-left-mini--aIHf7',
        'margin-small': 'margin-small--1puQg',
        'padding-small': 'padding-small--2a9in',
        'margin-top-small': 'margin-top-small--22Hmg',
        'padding-top-small': 'padding-top-small--3rLb4',
        'margin-right-small': 'margin-right-small--3rNRw',
        'padding-right-small': 'padding-right-small--35l-V',
        'margin-bottom-small': 'margin-bottom-small--xB-Q6',
        'padding-bottom-small': 'padding-bottom-small--kdenN',
        'margin-left-small': 'margin-left-small--1iYIV',
        'padding-left-small': 'padding-left-small--2Qe4F',
        'margin-normal': 'margin-normal--1kRhs',
        'padding-normal': 'padding-normal--1wpFc',
        'margin-top-normal': 'margin-top-normal--16NSH',
        'padding-top-normal': 'padding-top-normal--2iN5r',
        'margin-right-normal': 'margin-right-normal--22Kgc',
        'padding-right-normal': 'padding-right-normal--22qBU',
        'margin-bottom-normal': 'margin-bottom-normal--2q14Z',
        'padding-bottom-normal': 'padding-bottom-normal--sn767',
        'margin-left-normal': 'margin-left-normal--13gdE',
        'padding-left-normal': 'padding-left-normal--9mbqo',
        'margin-large': 'margin-large--2Pbo0',
        'padding-large': 'padding-large--18Eoo',
        'margin-top-large': 'margin-top-large--1omMc',
        'padding-top-large': 'padding-top-large--2uIzH',
        'margin-right-large': 'margin-right-large--1m2CG',
        'padding-right-large': 'padding-right-large--1sm3s',
        'margin-bottom-large': 'margin-bottom-large--qyo8i',
        'padding-bottom-large': 'padding-bottom-large--36lrD',
        'margin-left-large': 'margin-left-large--2NLSs',
        'padding-left-large': 'padding-left-large--iuNAI',
        footer: 'footer--3YcZG',
        link: 'link--1FhTU'
      };
    },
    1173: function(a, n, t) {
      a.exports = {
        'margin-mini': 'margin-mini--3yS7B',
        'padding-mini': 'padding-mini--35PGS',
        'margin-top-mini': 'margin-top-mini--1bpPc',
        'padding-top-mini': 'padding-top-mini--vjtRr',
        'margin-right-mini': 'margin-right-mini--QH0Nr',
        'padding-right-mini': 'padding-right-mini--dmU3C',
        'margin-bottom-mini': 'margin-bottom-mini--3WciC',
        'padding-bottom-mini': 'padding-bottom-mini--3P3XZ',
        'margin-left-mini': 'margin-left-mini--1qMWV',
        'padding-left-mini': 'padding-left-mini--3102c',
        'margin-small': 'margin-small--TY2s5',
        'padding-small': 'padding-small--1Y5Ee',
        'margin-top-small': 'margin-top-small--1UijE',
        'padding-top-small': 'padding-top-small--2y04y',
        'margin-right-small': 'margin-right-small--3CE-D',
        'padding-right-small': 'padding-right-small--3Qr0n',
        'margin-bottom-small': 'margin-bottom-small--1f98H',
        'padding-bottom-small': 'padding-bottom-small--2dO_P',
        'margin-left-small': 'margin-left-small--3e_Qy',
        'padding-left-small': 'padding-left-small--14gAi',
        'margin-normal': 'margin-normal--2diAr',
        'padding-normal': 'padding-normal--2qW2r',
        'margin-top-normal': 'margin-top-normal--1NQEg',
        'padding-top-normal': 'padding-top-normal--2isT9',
        'margin-right-normal': 'margin-right-normal--12smW',
        'padding-right-normal': 'padding-right-normal--2ke6X',
        'margin-bottom-normal': 'margin-bottom-normal--2q9yK',
        'padding-bottom-normal': 'padding-bottom-normal--hrcGc',
        'margin-left-normal': 'margin-left-normal--Ne50R',
        'padding-left-normal': 'padding-left-normal--o7Gu4',
        'margin-large': 'margin-large--3_HNg',
        'padding-large': 'padding-large--1dj-f',
        'margin-top-large': 'margin-top-large--eFvpC',
        'padding-top-large': 'padding-top-large--UbGIu',
        'margin-right-large': 'margin-right-large--2LaRc',
        'padding-right-large': 'padding-right-large--1cogP',
        'margin-bottom-large': 'margin-bottom-large--1jSWH',
        'padding-bottom-large': 'padding-bottom-large--3n3Xt',
        'margin-left-large': 'margin-left-large--3W8b_',
        'padding-left-large': 'padding-left-large--1kFV0',
        langIcon: 'langIcon--3oSij',
        icon: 'icon--15Qli'
      };
    },
    1174: function(a, n, t) {
      a.exports = {
        'margin-mini': 'margin-mini--3nZzG',
        'padding-mini': 'padding-mini--fa9Zd',
        'margin-top-mini': 'margin-top-mini--lQedp',
        'padding-top-mini': 'padding-top-mini--2coF_',
        'margin-right-mini': 'margin-right-mini--Y7oxp',
        'padding-right-mini': 'padding-right-mini---VJx9',
        'margin-bottom-mini': 'margin-bottom-mini--3zAtb',
        'padding-bottom-mini': 'padding-bottom-mini--sGlGE',
        'margin-left-mini': 'margin-left-mini--3BdeV',
        'padding-left-mini': 'padding-left-mini--139pu',
        'margin-small': 'margin-small--1i6C-',
        'padding-small': 'padding-small--3ryBf',
        'margin-top-small': 'margin-top-small--21hdo',
        'padding-top-small': 'padding-top-small--1ihYo',
        'margin-right-small': 'margin-right-small--2NHcU',
        'padding-right-small': 'padding-right-small--3W7v-',
        'margin-bottom-small': 'margin-bottom-small--3a7T0',
        'padding-bottom-small': 'padding-bottom-small--1H99H',
        'margin-left-small': 'margin-left-small--2YVr8',
        'padding-left-small': 'padding-left-small--36R6n',
        'margin-normal': 'margin-normal--3Yy5s',
        'padding-normal': 'padding-normal--1ncZV',
        'margin-top-normal': 'margin-top-normal--3Fraz',
        'padding-top-normal': 'padding-top-normal--3Oz2-',
        'margin-right-normal': 'margin-right-normal--19S2S',
        'padding-right-normal': 'padding-right-normal--3ZvZW',
        'margin-bottom-normal': 'margin-bottom-normal--2LpBN',
        'padding-bottom-normal': 'padding-bottom-normal--1QsDl',
        'margin-left-normal': 'margin-left-normal--EN4_a',
        'padding-left-normal': 'padding-left-normal--1lQxg',
        'margin-large': 'margin-large--235WH',
        'padding-large': 'padding-large--1bA5d',
        'margin-top-large': 'margin-top-large--GX0bt',
        'padding-top-large': 'padding-top-large--vBqa2',
        'margin-right-large': 'margin-right-large--3w21z',
        'padding-right-large': 'padding-right-large--giWlT',
        'margin-bottom-large': 'margin-bottom-large--2rQD_',
        'padding-bottom-large': 'padding-bottom-large--2UShl',
        'margin-left-large': 'margin-left-large--1tIK4',
        'padding-left-large': 'padding-left-large--1pArV',
        navigator: 'navigator--1cLne',
        collapsed: 'collapsed--3_diI',
        title: 'title--1R-rw',
        controlBut: 'controlBut--3i6YB',
        rotateIcon: 'rotateIcon--Ovk-Q',
        logo: 'logo--2kLKY'
      };
    },
    1175: function(a, n, t) {
      a.exports = {
        'margin-mini': 'margin-mini--3yJFn',
        'padding-mini': 'padding-mini--1cNv6',
        'margin-top-mini': 'margin-top-mini--vZ93J',
        'padding-top-mini': 'padding-top-mini--1hbCe',
        'margin-right-mini': 'margin-right-mini--1jNuH',
        'padding-right-mini': 'padding-right-mini--uRM5a',
        'margin-bottom-mini': 'margin-bottom-mini--2M65Q',
        'padding-bottom-mini': 'padding-bottom-mini--XzsWR',
        'margin-left-mini': 'margin-left-mini--_CQvk',
        'padding-left-mini': 'padding-left-mini--1g620',
        'margin-small': 'margin-small--D31Rr',
        'padding-small': 'padding-small--1C_aT',
        'margin-top-small': 'margin-top-small--fOEdP',
        'padding-top-small': 'padding-top-small--18Bl-',
        'margin-right-small': 'margin-right-small--1uBTP',
        'padding-right-small': 'padding-right-small--1XqjQ',
        'margin-bottom-small': 'margin-bottom-small--1evpV',
        'padding-bottom-small': 'padding-bottom-small--OBCXN',
        'margin-left-small': 'margin-left-small--1BroU',
        'padding-left-small': 'padding-left-small--2Z5JT',
        'margin-normal': 'margin-normal--MiipT',
        'padding-normal': 'padding-normal--3Ffr_',
        'margin-top-normal': 'margin-top-normal--1z3bK',
        'padding-top-normal': 'padding-top-normal--1hxcD',
        'margin-right-normal': 'margin-right-normal--Ya2o8',
        'padding-right-normal': 'padding-right-normal--3n3tm',
        'margin-bottom-normal': 'margin-bottom-normal--4NyO0',
        'padding-bottom-normal': 'padding-bottom-normal--2ag_M',
        'margin-left-normal': 'margin-left-normal--YPIiP',
        'padding-left-normal': 'padding-left-normal--dvc04',
        'margin-large': 'margin-large--55Ao2',
        'padding-large': 'padding-large--1x2dC',
        'margin-top-large': 'margin-top-large--3IjYa',
        'padding-top-large': 'padding-top-large--gHlLx',
        'margin-right-large': 'margin-right-large--3-d_G',
        'padding-right-large': 'padding-right-large--1HEx0',
        'margin-bottom-large': 'margin-bottom-large--3F_9P',
        'padding-bottom-large': 'padding-bottom-large--2cPMK',
        'margin-left-large': 'margin-left-large--2JuF7',
        'padding-left-large': 'padding-left-large--2EiI2',
        loading: 'loading--3cBuX',
        hide: 'hide--2pEaO',
        fixed: 'fixed--39_iv',
        collapsed: 'collapsed--1osn3',
        content: 'content--22SHs',
        circle: 'circle--26x2v',
        roll: 'roll--1Pgjd'
      };
    },
    1176: function(a, n, t) {
      a.exports = {
        'margin-mini': 'margin-mini--1Za9y',
        'padding-mini': 'padding-mini--3pDTi',
        'margin-top-mini': 'margin-top-mini--3LfHn',
        'padding-top-mini': 'padding-top-mini--2b3Lw',
        'margin-right-mini': 'margin-right-mini--gQXv3',
        'padding-right-mini': 'padding-right-mini--5qvTo',
        'margin-bottom-mini': 'margin-bottom-mini--3M4q7',
        'padding-bottom-mini': 'padding-bottom-mini--32N0J',
        'margin-left-mini': 'margin-left-mini--3zllI',
        'padding-left-mini': 'padding-left-mini--3IRUl',
        'margin-small': 'margin-small--nsH6d',
        'padding-small': 'padding-small--3sZsR',
        'margin-top-small': 'margin-top-small--1FnF_',
        'padding-top-small': 'padding-top-small--1mN90',
        'margin-right-small': 'margin-right-small--2QN4r',
        'padding-right-small': 'padding-right-small--TeuYZ',
        'margin-bottom-small': 'margin-bottom-small--28yHz',
        'padding-bottom-small': 'padding-bottom-small--1XrV4',
        'margin-left-small': 'margin-left-small--120sv',
        'padding-left-small': 'padding-left-small--10QC_',
        'margin-normal': 'margin-normal--3i46U',
        'padding-normal': 'padding-normal--dj0DU',
        'margin-top-normal': 'margin-top-normal--3SjpS',
        'padding-top-normal': 'padding-top-normal--LQx3A',
        'margin-right-normal': 'margin-right-normal--2Hc0k',
        'padding-right-normal': 'padding-right-normal--2EvEi',
        'margin-bottom-normal': 'margin-bottom-normal--1qKh_',
        'padding-bottom-normal': 'padding-bottom-normal--37Wok',
        'margin-left-normal': 'margin-left-normal--28hOO',
        'padding-left-normal': 'padding-left-normal--3qZ0o',
        'margin-large': 'margin-large--2WLjV',
        'padding-large': 'padding-large--24JcF',
        'margin-top-large': 'margin-top-large--2yc2_',
        'padding-top-large': 'padding-top-large--oUc0D',
        'margin-right-large': 'margin-right-large--3SXe1',
        'padding-right-large': 'padding-right-large--1FioS',
        'margin-bottom-large': 'margin-bottom-large--3xg6B',
        'padding-bottom-large': 'padding-bottom-large--1TrA7',
        'margin-left-large': 'margin-left-large--3pq02',
        'padding-left-large': 'padding-left-large--2jBAf',
        result: 'result--2VlSY',
        icon: 'icon--1itN6',
        failed: 'failed--Z-R6i',
        title: 'title--1VPhX',
        subTitle: 'subTitle--1Y-RN',
        extra: 'extra--14vEX',
        actions: 'actions--14P-F'
      };
    },
    229: function(a, n, t) {
      'use strict';
      ...
      var e = t(65),
        ...
        s = (function(a) {
          function n() {
            var a, t;
            Object(i.a)(this, n);
            for (var e = arguments.length, l = new Array(e), g = 0; g < e; g++) l[g] = arguments[g];
            return (
              ((t = Object(r.a)(
                this,
                (a = Object(m.a)(n)).call.apply(a, [this].concat(l))
              )).echartsDOM = void 0),
              t
            );
          }
            ...
            Object(l.a)(n, [
              {
                key: 'initChart',
                value: function() {
                  var a = this.renderChart();
                  Object(c.bind)(this.echartsDOM, function() {
                    a.resize();
                  });
                }
              },
              ...
              },
              {
                ...
                value: function() {
                  var a = this.props,
                    ...
                    t = a.theme;
                  return (
                    p.default.getInstanceByDom(this.echartsDOM) ||
                    p.default.init(this.echartsDOM, t, n)
                  );
                }
              },
              {
              ...
              },
              {
                key: 'dispose',
                value: function() {
                  Object(c.clear)(this.echartsDOM),
                    this.echartsDOM && p.default.dispose(this.echartsDOM);
                }
              },
              {
                key: 'renderChart',
                value: function() {
                  ...
                  return a.setOption(l[0] || {}, e || !1, i || !1), l[1] && a.setOption(l[1]), a;
                }
              },
              {
                key: 'render',
    ...
    231: function(a, n, t) {
      ...
      n.default = function(a) {
        var n = a.hideHeader,
          t = a.children,
          i = Object(e.a)(a, ['hideHeader', 'children']);
        return l.a.createElement(
          'div',
          { className: g.a.pageWrapper },
          !n && l.a.createElement(r.default, i),
          l.a.createElement('div', { className: g.a.pageBody }, t)
        );
      };
    },
    249: function(a, n, t) {
      ...
      n.default = function(a) {
        var n = a.title,
          ...
          r = a.actions,
          g = a.type,
          o = Object(e.a)(a, ['title', 'subtitle', 'extra', 'actions', 'type']),
          d = {
            failed: l.a.createElement(d, {
              className: ''.concat(m.a.icon, ' ').concat(m.a.failed),
              type: 'close-circle',
              theme: 'filled'
            }),
            successed: l.a.createElement(d, {
              className: m.a.icon,
              type: 'check-circle',
              theme: 'filled'
            })
        ...
        return l.a.createElement(
          'div',
          Object.assign({ className: m.a.result }, o),
          d[g],
          l.a.createElement('p', { className: m.a.title }, n),
          l.a.createElement('p', { className: m.a.subTitle }, t),
          i && l.a.createElement('div', { className: m.a.extra }, i),
          r && l.a.createElement('div', { className: m.a.actions }, r)
        );
      };
    },
    251: function(a, n, t) {
      ...
      var e = t(0),
        ...
        g = t(1175),
        o = t.n(g);
      n.default = Object(m.c)(function(a) {
        var n = a.spinning,
          t = a.fixed,
          e = a.collapsed,
          l = a.style;
        return i.a.createElement(
          ...
          i.a.createElement(
            ...
            i.a.createElement('div', { className: o.a.circle }),
    ...
    252: function(a, n, t) {
      ...
      var e = t(0),
        ...
        l = t(47),
        r = t(612);
      n.default = Object(l.b)('userStore')(function(a) {
        var n = a.userStore,
          t = a.children,
          e = a.routeAuthority,
          l = a.unidentified,
          m = 'undefined' === typeof t ? null : t,
          g = n.authority,
          o = Object(r.default)(e, g, m, l);
        return i.a.createElement(i.a.Fragment, null, o);
      });
    },
    253: function(a, n, t) {
      'use strict';
      ...
      var e = t(5),
        ...
        d = t(1171),
        p = t.n(d);
      n.default = Object(r.b)('layoutStore', 'localeStore')(
        Object(m.g)(
          Object(r.c)(function(a) {
            var n = function() {
                return a;
              },
              t = n(),
                ...
                m.map(function(a, n) {
                  ...
                  return t
                    ? l.a.createElement(
                        ...
                        {
                          key: n,
                          className: o()(p.a.breadcrumb, f(i) ? p.a.display : ''),
                          onClick: function() {
                            return (function(a) {
                              s !== a && c.push(a);
                            })(i);
    ...
    254: function(a, n, t) {
      ...
      n.default = function() {
        return r.a.createElement(
          ...
          p,
          ' ',
          r.a.createElement(e.a, { type: 'copyright' }),
          ' 2019 Created by',
          ' ',
          r.a.createElement(
            'a',
            { href: s, target: '_blank', rel: 'noopener noreferrer', className: o.a.link },
            c
          )
        );
      };
    ...
    255: function(a, n, t) {
      ...
      var e = t(212),
        ...
        p = t.n(d),
        c = o.i18n.languages,
        s = o.i18n.defaultLanguage;
      n.default = Object(g.b)('localeStore')(
        Object(g.c)(function(a) {
          var n = a.localeStore,
            t = function(a) {
              n.setLocale(a.key);
            };
          return m.a.createElement(
                ...
                return m.a.createElement(
                  ...
                  c.map(function(a) {
                    ...
                    return m.a.createElement(
                      l.a.Item,
                      { key: n, onClick: t },
                      m.a.createElement('span', { style: { marginRight: '5px' } }, e),
                      i
                    );
                  })
                );
            ...
            m.a.createElement(
              'div',
              { className: p.a.langIcon },
              m.a.createElement(i.a, { type: 'global', className: p.a.icon })
            )
          );
        })
      );
    ...
    256: function(a, n, t) {
      ...
      t.r(n);
      var e = t(588);
      t.d(n, 'Header', function() {
        return e.default;
      });
      var i = t(589);
      t.d(n, 'Navigator', function() {
        return i.default;
      });
    },
    555: function(a, n, t) {
      'use strict';
      t.r(n),
        t.d(n, 'BoxSvg', function() {
          return m;
        }),
        t.d(n, 'EmpolyeesSvg', function() {
          return g;
        }),
        t.d(n, 'OrdersSvg', function() {
          return o;
        }),
        t.d(n, 'SalesSvg', function() {
          return d;
        }),
        t.d(n, 'RainSvg', function() {
          return p;
        }),
        t.d(n, 'SnowSvg', function() {
          return c;
        }),
        t.d(n, 'CloudySvg', function() {
          return s;
        }),
        t.d(n, 'OvercastSvg', function() {
          return f;
        }),
        t.d(n, 'ThunderSvg', function() {
          return u;
        }),
        t.d(n, 'SunSvg', function() {
          return h;
        }),
        t.d(n, 'RLogo', function() {
          return l;
        }),
        t.d(n, 'RLogo1', function() {
          return r;
        }),
        t.d(n, 'FogSvg', function() {
          return b;
        });
      var e = t(0),
        i = t.n(e),
        l = function() {
          return i.a.createElement(
            ...
            i.a.createElement('defs', null, i.a.createElement('style', { type: 'text/css' })),
    ...
    588: function(a, n, t) {
      ...
      var e = t(5),
        ...
        p = t.n(d),
        c = t(615);
      n.default = Object(r.b)('layoutStore')(
        Object(r.c)(function(a) {
          var n = a.layoutStore,
            t = n.toggleCollapsed,
            i = n.collapsed,
            r = n.isMobile,
            m = i ? 'menu-unfold' : 'menu-fold';
          return l.a.createElement(
            'header',
            { className: g()(p.a.header, i ? p.a.collapsed : '', r ? p.a.isMobile : '') },
            l.a.createElement(e.a, {
              type: m,
              className: p.a.foldIcon,
              onClick: function() {
                return t();
              }
            }),
            l.a.createElement(
              'div',
              { className: p.a.rightPart },
              l.a.createElement(c.default, null),
              l.a.createElement(o.default, null)
            )
          );
        })
      );
      ...
      n.default = function(a) {
        ...
        return n
          ? l.a.createElement(
              ...
              l.a.createElement(r.default, null)
            )
          : l.a.createElement(r.default, null);
      };
    },
        ...
        if (Array.isArray(a)) {
          if (Array.isArray(n)) {
            if (
              ...
              return t;
          } else if (a.includes(n)) return t;
          return e;
        }
        if ('string' === typeof a) {
          if ('all' === a) return n ? t : e;
          if (a === n) return t;
          if (Array.isArray(n))
    ...
    613: function(a, n, t) {
      ...
      var e = t(4),
        i = t.n(e);
      t(664), t(665), t(666), t(667), t(373), t(669), t(668), t(372);
      n.default = i.a;
    },
    615: function(a, n, t) {
      'use strict';
      ...
      var e = t(212),
        ...
        c = t.n(p),
        s = r.a.confirm;
      n.default = Object(o.b)('userStore')(
        Object(d.g)(
          Object(o.c)(function(a) {
            var n = a.userStore,
              t = n.userInfo,
              r = n.reloadUserInfo,
              o = n.userLogout,
                ...
                e.a,
                {
                  overlay: g.a.createElement(
                    ...
                    g.a.createElement(
                      i.a.Item,
                      null,
                      g.a.createElement(l.a, { type: 'user' }),
                      g.a.createElement('span', { className: c.a.menuItem }, 'user info')
                    ),
                    g.a.createElement(
                      i.a.Item,
                      { onClick: f },
                      g.a.createElement(l.a, { type: 'setting' }),
                      g.a.createElement('span', { className: c.a.menuItem }, 'trigger error')
                    ),
                    g.a.createElement(i.a.Divider, null),
                    g.a.createElement(
                      i.a.Item,
                      { onClick: p },
                      g.a.createElement(l.a, { type: 'logout' }),
                      g.a.createElement('span', { className: c.a.menuItem }, 'logout')
                    )
                  ),
                  className: c.a.userDropdown,
                  placement: 'bottomRight'
                },
                g.a.createElement(
                  'div',
                  { className: c.a.userDropdown },
                  g.a.createElement(l.a, { type: 'user', className: c.a.userIcon }),
                  g.a.createElement('span', { className: c.a.text }, t.nickname)
                )
              )
            );
          })
    ...
    616: function(a, n, t) {
      ...
      var e = t(5),
        ...
        b = t.n(h),
        v = r.a.SubMenu;
      n.default = Object(p.b)('layoutStore', 'userStore', 'localeStore')(
        Object(d.g)(
          Object(p.c)(function(a) {
            var n = Object(m.useState)([]),
              t = Object(l.a)(n, 2),
              d = t[0],
              p = t[1],
              s = a.location.pathname,
              ...
              z = E.toggleCollapsed,
              N = E.collapsed,
              O = h.userStore.authority,
              x = h.localeStore.localeObj;
            function j() {
              var a = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : '',
                n = arguments.length > 1 ? arguments[1] : void 0,
                t = arguments.length > 2 ? arguments[2] : void 0,
                i = n ? 'menu.'.concat(n, '.').concat(a) : 'menu.'.concat(a);
              return g.a.createElement(
                'span',
                null,
                t && g.a.createElement(e.a, { type: t }),
                g.a.createElement('span', null, x[i] || a)
              );
            }
            function w(a, n) {
              return a.length
                ? a
                    .filter(function(a) {
                      var n = a.authority;
                      return !a.hideMenu && (!n || Object(c.intersection)(O, n).length > 0);
                    })
                    .map(function(a) {
                      return (function(a, n) {
                        if (
                          ...
                          var t = a.icon,
                            ...
                            l = a.path,
                            m = a.routes;
                          return g.a.createElement(v, { title: j(i, n, t), key: l }, w(m, i));
                        }
                        return g.a.createElement(
                          r.a.Item,
                          { key: a.path },
                          (function(a, n) {
                            var t = a.icon,
                              i = a.name,
                              l = a.path,
                              r = n ? 'menu.'.concat(n, '.').concat(i) : 'menu.'.concat(i);
                            return g.a.createElement(
                              o.b,
                              {
                                to: l,
                              ...
                              t && g.a.createElement(e.a, { type: t }),
                              g.a.createElement('span', null, x[r] || i)
                            );
                          })(a, n)
                        );
                      })(a, n);
            ...
            Object(m.useEffect)(function() {
              !(function() {
                var a,
                  n = y[1].routes,
                  t = s.split('/').reduce(function(t, e) {
                    return (
                      e &&
                        (a = (function(a, n) {
                          var t = Array.isArray(a);
                          return (t ? a : a.routes).find(function(e) {
                            return e.path === (t ? '' : a.path) + '/' + n;
                          });
                        })(a || n, e)) &&
                        a.routes &&
                        t.push(a.path),
            ...
            return g.a.createElement(
              'aside',
              { className: f()(b.a.navigator, N ? b.a.collapsed : '') },
              g.a.createElement(
                'a',
                {
                  className: b.a.controlBut,
                  href: u.menuLinkUrl,
                  target: '_blank',
                  rel: 'noopener noreferrer'
                },
                g.a.createElement('img', { alt: '', src: u.logoPath, className: b.a.logo }),
                g.a.createElement('span', { className: 'ml-2 '.concat(b.a.title) }, u.siteName)
              ),
              g.a.createElement(
                r.a,
                Object.assign(
                  {
                    ...
                    onOpenChange: function(a) {
                      ...
                      (N && !a.length) || p(n ? [a.pop()] : Object(i.a)(a));
                    }
                  },
                  S
                ),
    ...
    617: function(a, n, t) {
      ...
      n.default = function(a) {
        ...
        return i.a.createElement(
          'div',
          { className: m.a.pageHeader },
          !n && i.a.createElement(l.default, null),
          o && i.a.createElement('div', { className: m.a.logo }, o),
          i.a.createElement(
            'div',
            { className: m.a.main },
            i.a.createElement(
              'div',
              { className: m.a.row },
              t && i.a.createElement('h1', { className: m.a.title }, t),
              e && i.a.createElement('div', { className: m.a.subTitle }, e)
            ),
            i.a.createElement(
              'div',
              { className: m.a.row },
              r && i.a.createElement('div', { className: m.a.content }, r),
              g && i.a.createElement('div', { className: m.a.extraContent }, g)
            )
          )
        );
      };
