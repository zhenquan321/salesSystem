      ...
      function P(e, t) {
        ...
        if ((t && (u.display = 'none'), l)) {
          ...
          if (
            ...
            var b = Object(C.e)(d, s, !0),
              m = d.offsetHeight;
            r.inkBar &&
              void 0 !== r.inkBar.height &&
              (m = parseFloat(r.inkBar.height, 10)) &&
              (b += (d.offsetHeight - m) / 2),
              h
                ? (Object(C.j)(u, 'translate3d(0,' + b + 'px,0)'), (u.top = '0'))
                : (u.top = b + 'px'),
              (u.height = m + 'px');
          }
        }
                    ...
                    y.a.Children.forEach(n, function(t, f) {
                      if (t) {
                        ...
                        var b = o && f === n.length - 1 ? 0 : o,
                          m = x()({}, Object(C.i)(c) ? 'marginBottom' : 'marginRight', b);
                ...
                return y.a.createElement(M, null, function(e, r) {
                  return y.a.createElement(
                    ...
                    y.a.createElement(
                      ...
                      y.a.createElement(R, a()({ saveRef: e, renderTabBarNode: t }, n)),
                      y.a.createElement(T, a()({ saveRef: e, getRef: r }, n))
                    )
                  );
                });
              }
                ...
                value: function() {
                  ...
                  return m.a.createElement(K, null, function(e) {
                    ...
                    return (
                      s &&
                        b &&
                        ((c = m.a.createElement(W, { setRef: i, prevElement: t })),
                        (l = m.a.createElement(W, { setRef: o, nextElement: r }))),
                      m.a.createElement(
                        'div',
                        a()(
                          {
                ...
                },
                {
                  ...
                  value: function() {
                    ...
                    var h = m.a.cloneElement(this.tabBar, {
                      ...
                      y = m.a.createElement(W, {
                        key: 'sentinelStart',
                        setRef: this.setSentinelStart,
                        nextElement: this.panelSentinelStart
                      }),
                      b = m.a.createElement(W, {
                        key: 'sentinelEnd',
                      ...
                      g = [];
                    return (
                      'bottom' === i ? g.push(y, v, b, h) : g.push(h, y, v, b),
                      m.a.createElement(
                        A,
                        {
                          value: {
