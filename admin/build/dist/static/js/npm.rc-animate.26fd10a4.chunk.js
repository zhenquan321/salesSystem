                  ...
                  value: function() {
                    ...
                    return p
                      ? t !== D && a(this.props)
                        ...
                        : l
                        ? p(i()({}, d), this.setNodeRef)
                        : f
                        ? null
                        : p(i()({}, d, { className: v }), this.setNodeRef)
                      : null;
                  }
                }
              ],
              [
                {
                  ...
                  value: function(e, n) {
                    ...
                    var r = e.visible,
                      ...
                      s = e.motionEnter,
                      u = e.motionLeave,
                      p = e.motionLeaveImmediately,
                      c = { prevProps: e };
                    return (
                      ((o === K && !i) || (o === M && !s) || (o === W && !u)) &&
                        ((c.status = D), (c.statusActive = !1), (c.newStatus = !1)),
                      !t && r && i && ((c.status = K), (c.statusActive = !1), (c.newStatus = !0)),
                      t &&
                        !t.visible &&
                        r &&
                        s &&
                        ((c.status = M), (c.statusActive = !1), (c.newStatus = !0)),
                      ((t && t.visible && !r && u) || (!t && p && !r && u)) &&
                        ((c.status = W), (c.statusActive = !1), (c.newStatus = !0)),
                      c
                    );
                  }
                }
          ...
          for (var e = [], n = 0; n < arguments.length; n++) {
            ...
            if (a) {
              ...
              if ('string' === r || 'number' === r) e.push(a);
                ...
                i && e.push(i);
              } else if ('object' === r) for (var s in a) t.call(a, s) && a[s] && e.push(s);
            }
          }
          return e.join(' ');
        }
              ...
              },
              {
                ...
                value: function(e, n) {
                  ...
                  if ((g.b || !o.animation[e]) && r && o[P[e]]) {
                    var u = i ? r[e] : r + '-' + e,
                      p = u + '-active';
                    i && r[e + 'Active'] && (p = r[e + 'Active']),
                      (this.stopper = Object(g.a)(a, { name: u, active: p }, s));
              ...
              value: function(e) {
                ...
                o
                  ...
                  : (u = (function(e, n) {
                      ...
                      return (
                        e.forEach(function(e) {
                          e && b(n, e.key) ? o.length && ((a[e.key] = o), (o = [])) : o.push(e);
                        }),
                  ...
                  t.forEach(function(e) {
                    ...
                    if (!e || !r[t]) {
                      ...
                      if (o) {
                        var i = e.props[o];
                        if (a) !L(s, t, o) && i && n.keysToEnter.push(t);
                  ...
                  s.forEach(function(e) {
                    ...
                    if (!e || !r[a]) {
                      ...
                      if (o) {
                        var s = e.props[o];
                        if (i) !L(t, a, o) && s && n.keysToLeave.push(a);
