        ...
        if ((t && (u.display = 'none'), l)) {
          ...
          if (
            ...
            r.inkBar &&
              ...
              v
                ? (Object(O.j)(u, 'translate3d(0,' + y + 'px,0)'), (u.top = '0'))
                : (u.top = y + 'px'),
              (u.height = m + 'px');
          }
        }
                    ...
                    b.a.Children.forEach(n, function(t, f) {
                      if (t) {
                        ...
                        var y = o && f === n.length - 1 ? 0 : o,
                          m = x()({}, Object(O.i)(c) ? 'marginBottom' : 'marginRight', y);
                ...
                value: function() {
                  ...
                  return m.a.createElement(A, null, function(e) {
                    ...
                    return (
                      s &&
                        y &&
                        ((c = m.a.createElement(z, { setRef: i, prevElement: t })),
